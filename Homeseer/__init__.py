...
eg.RegisterPlugin(
    ...
    version = "0.0.2",
    kind = "other",
    description = "Homeseer plugin. More info on http://www.ihomeautomate.eu/"
)
...
class HomeseerPlugin(eg.PluginBase):
    ...
    def Configure(self, hostname="localhost", username="default", password="default"):
        ...
        while panel.Affirmed():
            panel.SetResult(hostnameTextControl.GetValue(),usernameTextControl.GetValue(),passwordTextControl.GetValue())
